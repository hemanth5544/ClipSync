...
/** Isometric-style illustrations for the features section (Raycast-inspired). Violet glow accents. */
  ...
  return (
    <div className="relative flex h-full min-h-[200px] items-center justify-center md:min-h-[260px]">
      <svg viewBox="0 0 200 160" className="h-full w-full max-w-[280px]" aria-hidden>
        ...
        <rect x="30" y="70" width="50" height="36" rx="6" fill="#1e1b4b" stroke="rgba(124,58,237,0.4)" strokeWidth="1.5" />
        <rect x="120" y="70" width="50" height="36" rx="6" fill="#1e1b4b" stroke="rgba(124,58,237,0.4)" strokeWidth="1.5" />
        ...
        <circle cx="55" cy="88" r="4" fill="#7c3aed" opacity="0.9" />
        <circle cx="145" cy="88" r="4" fill="#a78bfa" opacity="0.9" />
      </svg>
    </div>
  )
}
  ...
  return (
    <div className="relative flex h-full min-h-[200px] items-center justify-center md:min-h-[260px]">
      <svg viewBox="0 0 200 160" className="h-full w-full max-w-[280px]" aria-hidden>
        ...
        {/* Shield shape */}
        <path d="M 100 40 L 140 55 L 140 95 Q 100 120 60 95 L 60 55 Z" fill="#1e1b4b" stroke="rgba(124,58,237,0.5)" strokeWidth="1.5" />
        {/* Lock body */}
        <rect x="85" y="75" width="30" height="28" rx="4" fill="url(#secure-glow)" filter="url(#secure-blur)" />
        <path d="M 92 75 L 92 68 Q 92 60 100 60 Q 108 60 108 68 L 108 75" fill="none" stroke="#c4b5fd" strokeWidth="3" strokeLinecap="round" />
      </svg>
    </div>
  )
}
  ...
  return (
    <div className="relative flex h-full min-h-[200px] items-center justify-center md:min-h-[260px]">
      <svg viewBox="0 0 200 160" className="h-full w-full max-w-[280px]" aria-hidden>
        ...
        {/* Magnifier circle */}
        <circle cx="85" cy="75" r="32" fill="none" stroke="rgba(124,58,237,0.6)" strokeWidth="3" />
        <circle cx="85" cy="75" r="20" fill="#1e1b4b" />
        {/* Handle */}
        <line x1="110" y1="100" x2="135" y2="125" stroke="rgba(124,58,237,0.6)" strokeWidth="4" strokeLinecap="round" />
  ...
  return (
    <div className="relative flex h-full min-h-[200px] items-center justify-center md:min-h-[260px]">
      <svg viewBox="0 0 200 160" className="h-full w-full max-w-[280px]" aria-hidden>
        ...
        <path d="M 55 75 L 55 115 L 115 115 L 145 95 L 145 75 Z" fill="#1e1b4b" stroke="rgba(124,58,237,0.4)" strokeWidth="1.5" />
        <path d="M 65 85 L 65 120 L 120 120 L 148 102 L 148 85 Z" fill="#252240" stroke="rgba(167,139,250,0.35)" strokeWidth="1" />
        <path d="M 75 95 L 75 125 L 125 125 L 150 108 L 150 95 Z" fill="#2e2a4a" stroke="rgba(196,181,253,0.3)" strokeWidth="1" />
        {/* Tab glow */}
  ...
  return (
    <div className="relative flex h-full min-h-[200px] items-center justify-center md:min-h-[260px]">
      <svg viewBox="0 0 200 160" className="h-full w-full max-w-[280px]" aria-hidden>
        ...
        {/* Keyboard key shapes */}
        <rect x="70" y="70" width="60" height="28" rx="6" fill="#1e1b4b" stroke="rgba(124,58,237,0.4)" strokeWidth="1.5" />
        <text x="100" y="90" textAnchor="middle" fill="#a78bfa" fontSize="14" fontFamily="system-ui, sans-serif" fontWeight="600">⌘V</text>
        <rect x="80" y="108" width="40" height="22" rx="4" fill="#252240" stroke="rgba(167,139,250,0.35)" strokeWidth="1" />
        <rect x="128" y="108" width="40" height="22" rx="4" fill="#252240" stroke="rgba(167,139,250,0.35)" strokeWidth="1" />
  ...
  return (
    <div className="relative flex h-full min-h-[200px] items-center justify-center md:min-h-[260px]">
      <svg viewBox="0 0 200 160" className="h-full w-full max-w-[280px]" aria-hidden>
        ...
        {/* Cloud shape */}
        <ellipse cx="100" cy="95" rx="45" ry="28" fill="#1e1b4b" stroke="rgba(124,58,237,0.4)" strokeWidth="1.5" />
        ...
        {/* Up arrow (upload) */}
        <path d="M 100 65 L 100 85 M 92 73 L 100 65 L 108 73" fill="none" stroke="#a78bfa" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" />
      </svg>
    </div>
  )
}
